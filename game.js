...
let dx = 10;                                                                         //býr til breytu dx sem setur hraða á x gildin
let dy = -10;                                                                        //býr til breytu dy sem setur hraða á y gildin
  ...
  if(y + dy < ballRadius) {                                                         //ef bolti hittir loftið þá kemur hann aftur til baka
    ...
    if(x > paddleX && x < paddleX + paddleWidth) {
      ...
      if(!lives) {
        ...
        dx = 10;                                                                     //setur x hraða í 10
        dy = -10;                                                                    //setur y hraða í 10
